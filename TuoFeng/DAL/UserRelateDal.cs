...
namespace TuoFeng.DAL
{
	...
	/// 数据访问类:UserRelate
	/// </summary>
	public partial class UserRelateDal
	{
		public UserRelateDal()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "UserRelate"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from UserRelate");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from UserRelate ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,UserId,RelateUserId,IsDelete,CreateTime ");
			strSql.Append(" FROM UserRelate ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,UserId,RelateUserId,IsDelete,CreateTime ");
			strSql.Append(" FROM UserRelate ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from UserRelate T ");
