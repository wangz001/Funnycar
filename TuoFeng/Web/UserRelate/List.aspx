<%@ Page Title="UserRelate" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.UserRelate.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="RelateUserId" HeaderText="RelateUserId" SortExpression="RelateUserId" ItemStyle-HorizontalAlign="Center"  /> 
