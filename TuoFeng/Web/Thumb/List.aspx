<%@ Page Title="Thumb" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.Thumb.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="TravelPartId" HeaderText="TravelPartId" SortExpression="TravelPartId" ItemStyle-HorizontalAlign="Center"  /> 
