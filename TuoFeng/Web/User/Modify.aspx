...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtShowName" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		PassWord
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtPhoneNum" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		Email
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:CheckBox ID="chkIsEnable" Text="IsEnable" runat="server" Checked="False" />
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		CreateTime
