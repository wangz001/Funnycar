<%@ Page Title="Travels" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.Travels.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="TravelName" HeaderText="TravelName" SortExpression="TravelName" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="CoverImage" HeaderText="封面图" SortExpression="CoverImage" ItemStyle-HorizontalAlign="Center"  /> 
