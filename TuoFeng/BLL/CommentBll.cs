...
namespace TuoFeng.BLL
{
	...
	{
		private readonly CommentDal dal=new CommentDal();
		public CommentBll()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Comment GetModelByCache(long Id)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Comment> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Comment> DataTableToList(DataTable dt)
		{
